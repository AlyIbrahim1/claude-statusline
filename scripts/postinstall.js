...
try {
  ...
  // Not result.settingsPath: a failed setup has none, and the warning below must still print.
  const commandsDir = path.join(path.dirname(config.getSettingsPath()), 'commands');
